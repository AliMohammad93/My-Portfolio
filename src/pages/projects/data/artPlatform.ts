...
const artPlatform: IProjectData = {
    ...
    en: {
        ...
        projectDescription: [
            ...
            "Events: This section allows users to add or discover art events in a specific area, making it easier for them to connect with other artists and art enthusiasts.",
            "Services: Users can offer or request art services like graphic design, interior design, or drawing in this section, helping them find opportunities to collaborate with other artists or get paid for their skills."
        ],
        responsibility: {
    ...
    de: {
        ...
        projectDescription: [
            ...
            "Veranstaltungen: In diesem Bereich können Benutzer Kunstveranstaltungen in einer bestimmten Region hinzufügen oder entdecken, was es ihnen erleichtert, sich mit anderen Künstlern und Kunstliebhabern zu vernetzen.",
            "Dienstleistungen: Benutzer können in diesem Bereich Kunstservices wie Grafikdesign, Innenarchitektur oder Zeichnung anbieten oder anfordern, was ihnen hilft, Möglichkeiten zur Zusammenarbeit mit anderen Künstlern zu finden oder für ihre Fähigkeiten bezahlt zu werden."
        ],
        responsibility: {
