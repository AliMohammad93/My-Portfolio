    ...
    en: {
        ...
        responsibility: {
            ...
            responsibilities: [
                ...
                "Creating a robust back-end system using Firebase Realtime Database, Firestore, and Authentication to handle user data, car plate information, and app notifications.",
        ...
        achievement: {
            ...
            achievements: [
                ...
                "Designed and implemented a user-friendly interface and efficient search functionality to enhance the user experience.",
                "Developed a comprehensive back-end system using Firebase technologies to handle user data and notifications.",
                "Demonstrated the ability to work independently as the sole developer on this project and published the app on both major app stores."
            ]
        }
    },
    de: {
        ...
        responsibility: {
            ...
            responsibilities: [
                ...
                "Erstellung eines robusten Back-End-Systems mit Firebase Realtime Database, Firestore und Authentication zur Handhabung von Benutzerdaten, Autokennzeicheninformationen und App-Benachrichtigungen. ",
                "Integration von Expo Push Notifications, um Benutzern Echtzeit-Updates zu bieten. • Testen und Debuggen der App auf iOS- und Android-Plattformen.",
                "Veröffentlichen der App auf Google Play und App Store. Verwendete Technologien: • React Native • Firebase Realtime Database, Firestore, Authentication und Storage.",
                "Expo Push Notifications Hauptleistungen.",
                "Erfolgreiche Entwicklung und Bereitstellung einer voll funktionsfähigen plattformübergreifenden mobilen App, die es Benutzern ermöglicht, basierend auf ihren Autokennzeichen miteinander in Kontakt zu treten.",
                "Design und Implementierung einer benutzerfreundlichen Benutzeroberfläche und effizienten Suchfunktion, um das Benutzererlebnis zu verbessern.",
                "Entwicklung eines umfassenden Back-End-Systems mit Firebase-Technologien zur Handhabung von Benutzerdaten und Benachrichtigungen.",
                "Nachgewiesene Fähigkeit, als einziger Entwickler an diesem Projekt unabhängig zu arbeiten und die App auf beiden großen App-Stores zu veröffentlichen."
            ]
        },
        technology: {
        ...
        achievement: {
            ...
            achievements: [
                ...
                "Entwurf und Implementierung einer benutzerfreundlichen Benutzeroberfläche und effizienter Suchfunktionen zur Verbesserung der Benutzererfahrung.",
                "Entwicklung eines umfassenden Back-End-Systems unter Verwendung von Firebase-Technologien zur Verwaltung von Benutzerdaten und Benachrichtigungen.",
                "Nachweis der Fähigkeit, unabhängig als alleiniger Entwickler an diesem Projekt zu arbeiten und die App in beiden großen App-Stores zu veröffentlichen."
            ]
        }
    }
};
